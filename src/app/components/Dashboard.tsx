        ...
        <div className="bg-card border border-border rounded-lg p-5 hover:shadow-lg hover:shadow-black/20 transition-all duration-200">
          ...
          <ResponsiveContainer width="100%" height={140}>
            <AreaChart data={availabilitySeries}>
              <defs><linearGradient id="dispGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#1d6cf0" stopOpacity={0.2} /><stop offset="95%" stopColor="#1d6cf0" stopOpacity={0} /></linearGradient></defs>
              <CartesianGrid strokeDasharray="2 4" stroke="rgba(148,163,184,0.06)" />
              <XAxis dataKey="mes" tick={{ fill: "#64748b", fontSize: 11 }} axisLine={false} tickLine={false} />
